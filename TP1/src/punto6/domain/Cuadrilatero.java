...
public class Cuadrilatero implements Forma {
  ...
  public void area() {
    if (esCuadrado()) {
      ...
      double s = (this.lado1 + this.lado2 + this.lado3 + this.lado4) / 2;
  ...
  // Muestra el perimetro de un cuadrilatero
  @Override
  public void perimetro() {
    System.out.println("***** EL PERIMETRO DEL CUADRILATERO ES: " + String.format("%.2f", this.lado1 + this.lado2 + this.lado3 + this.lado4) + " *****");
  }
}
